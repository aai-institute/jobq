...
def run_command(
    ...
    stdout_stream: list[str] | None = None,
    stderr_stream: list[str] | None = None,
    ...
    stdout: list[str] = stdout_stream if stdout_stream is not None else []
    stderr: list[str] = stderr_stream if stderr_stream is not None else []
    output: list[str] = []
