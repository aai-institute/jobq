...
class DefaultApi:
    ...
    def logs_logs_job_id_get(
        ...
        _param = self._logs_logs_job_id_get_serialize(
            job_id=job_id,
            namespace=namespace,
    ...
    @validate_call
    def logs_logs_job_id_get_with_http_info(
        self,
        job_id: StrictStr,
        namespace: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def logs_logs_job_id_get_without_preload_content(
        self,
        job_id: StrictStr,
        namespace: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _logs_logs_job_id_get_serialize(
        self,
        job_id,
        namespace,
        _request_auth,
